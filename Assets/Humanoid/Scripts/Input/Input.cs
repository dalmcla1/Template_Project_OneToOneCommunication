    ...
    public class InputEvent {
        ...
        public virtual float floatValue {
            ...
            set {
                ...
                int newIntValue = (int)Mathf.Round(value);
        ...
        public Object[] objMethodComponents;
        ...
        private MethodInfo[] GetSupportedMethods(GameObject obj, out string[] methodNames, out Object[] methodComponents) {
            ...
            for (int i = 0; i < components.Length; i++) {
                AddMethodNames(components[i], ref methodNames, ref methodComponents, ref methods);
            }
            AddMethodNames(obj, ref methodNames, ref methodComponents, ref methods);
            return methods;
        }

        private void AddMethodNames(Object component, ref string[] methodNames, ref Object[] methodComponents, ref MethodInfo[] methods) {
            if (component == null || component is Transform || component is Animator || component is ControllerInput)
                return;
#if hNW_PHOTON
            ...
            MethodInfo[] componentMethods = GetSupportedMethods(component.GetType(), out componentMethodNames);
#if UNITY_WSA_10_0 && !UNITY_EDITOR
                if (components[i].GetType() != typeof(HumanoidControl) && !components[i].GetType().GetTypeInfo().IsSubclassOf(typeof(Target)))
#else
            if (component.GetType() != typeof(HumanoidControl) && !component.GetType().IsSubclassOf(typeof(HumanoidTarget)))
#endif
                AddComponentName(component.GetType().Name, ref componentMethodNames);

            methodNames = Extend(methodNames, componentMethodNames);
            methodComponents = Extend(methodComponents, component, componentMethodNames.Length - 1);
        ...
        public static Object[] Extend(Object[] a1, Object a2, int n) {
            Object[] r = new Object[a1.Length + n];
        ...
        protected void InvokeIntMethod(Object target) {
            ...
            if (intMethod != null) {
                InvokeMethod(() => intMethod.Invoke(_intValue));
                return;
            }
        ...
        protected void InvokeBoolMethod(Object target) {
            if (boolMethod != null) {
                InvokeMethod(() => boolMethod.Invoke(_boolValue));
                return;
            }
