...
namespace Passer {
    ...
    public class HumanoidControl : MonoBehaviour {
        ...
        public void ScaleAvatarToTracking() {
            ...
            Debug.Log(localNeckPosition.y + " / " + avatarNeckHeight + " " + headTarget.unityVRHead.cameraTransform.position.y + " " + headTarget.neck2eyes);
        ...
        private void CalculateVelocityAcceleration() {
            if (lastTime > 0) {
                ...
                if (!isRemote) {
                    ...
                    //Debug.Log(this.gameObject + "V = " + velocity.z);
                }
            }
            lastTime = Time.time;
