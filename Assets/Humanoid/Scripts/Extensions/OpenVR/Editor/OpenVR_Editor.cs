...
namespace Passer.Humanoid {
    ...
    [InitializeOnLoad]
    public class OpenVrCleanup {

        // Cleanup OpenVR devices when OpenVR is disabled in the preferences
        static OpenVrCleanup() {
            OpenVRHmd[] openVRHmds = Object.FindObjectsOfType<OpenVRHmd>();
            foreach(OpenVRHmd hmd in openVRHmds)
                Object.DestroyImmediate(hmd.gameObject, true);
            
            OpenVRController[] controllers = Object.FindObjectsOfType<OpenVRController>();
