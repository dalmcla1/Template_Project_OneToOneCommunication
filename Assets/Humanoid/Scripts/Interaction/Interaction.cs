...
namespace Passer {
    ...
    public class Interaction : BaseInputModule {
        ...
        public void ActivatePointing(int inputDevice, bool active) {
            ...
            if (pointers[inputDevice].focusingEnabled)
                pointers[inputDevice].ProcessFocus();
            else {
                pointers[inputDevice].ProcessNoFocus();
            }
        }
        ...
        private void ProcessPointer(InteractionPointer pointer, InputDeviceIDs inputDeviceID) {
            ...
            //if (pointer.type == PointerType.Point) {
            //    if (pointer.focusingEnabled)
            //        pointer.ProcessFocus();
            //    else
            //        pointer.ProcessNoFocus();
            //}
