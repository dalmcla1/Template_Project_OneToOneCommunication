...
namespace Passer {
    ...
    public class HandInteraction {
        public static float kinematicMass = 1; // masses < 1 will move kinematic when not colliding
        public static float maxGrabbingMass = 10; // maxMass you can grab is 10
        ...
        public static void GrabCheck(HandTarget handTarget, GameObject obj) {
            if (handTarget.grabbing == false ||
                grabChecking ||
                handTarget.grabbedObject != null ||
                handTarget.humanoid.isRemote) {
        ...
        private static void GrabRigidbodyParenting(HandTarget handTarget, Rigidbody objRigidbody) {
            ...
            if (handTarget.humanoid.humanoidNetworking != null && !handTarget.humanoid.isRemote)
