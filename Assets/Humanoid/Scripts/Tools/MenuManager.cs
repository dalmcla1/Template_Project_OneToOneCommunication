...
public class MenuManagerHum : MonoBehaviour {
    ...
    protected void EnableMenuPointer(ControllerInput controllerInput) {
        ...
        if (controllerInput != null) {
            controllerInput.leftTrigger1Input.SetMethod(leftMenuPointer.Click, InputEvent.EventType.Change);
            controllerInput.rightTrigger1Input.SetMethod(rightMenuPointer.Click, InputEvent.EventType.Change);
        }
    }
    ...
    protected void DisableMenuPointer(ControllerInput controllerInput) {
        ...
        if (controllerInput != null) {
            controllerInput.leftTrigger1Input.SetMethod((InputEvent.VoidMethod)null, InputEvent.EventType.None);
            controllerInput.rightTrigger1Input.SetMethod((InputEvent.VoidMethod)null, InputEvent.EventType.None);
        }
    }
    ...
    protected void EnableTeleporter(ControllerInput controllerInput) {
        ...
        if (controllerInput != null) {
            controllerInput.leftStickButtonInput.SetMethod(leftTeleporter.Activation, InputEvent.EventType.Change);
            controllerInput.rightStickButtonInput.SetMethod(rightTeleporter.Activation, InputEvent.EventType.Change);

            controllerInput.leftTrigger1Input.SetMethod(leftTeleporter.Click, InputEvent.EventType.Change);
            controllerInput.rightTrigger1Input.SetMethod(rightTeleporter.Click, InputEvent.EventType.Change);
        }
    }
    ...
    protected void DisableTeleporter(ControllerInput controllerInput) {
        ...
        if (controllerInput != null) {
            controllerInput.leftStickButtonInput.SetMethod((InputEvent.VoidMethod)null, InputEvent.EventType.None);
            controllerInput.rightStickButtonInput.SetMethod((InputEvent.VoidMethod)null, InputEvent.EventType.None);
        }
    }
